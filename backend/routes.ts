...
export function RegisterRoutes(app: express.Express) {
    ...
    app.post('/user',
        function(request: any, response: any, next: any) {
            const args = {
                data: { "in": "body", "name": "data", "required": true, "dataType": "nestedObjectLiteral", "nestedProperties": { "name": { "dataType": "string", "required": true }, "password": { "dataType": "string", "required": true }, "username": { "dataType": "string", "required": true } } },
            };
    ...
    app.put('/user/:userId/changePassword',
        ...
        function(request: any, response: any, next: any) {
            const args = {
                ...
                data: { "in": "body", "name": "data", "required": true, "dataType": "nestedObjectLiteral", "nestedProperties": { "newPwd": { "dataType": "string", "required": true }, "oldPwd": { "dataType": "string", "required": true } } },
            };
