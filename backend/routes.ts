  ...
  AuthToken: {
    ...
    properties: {
      id: {
        dataType: 'integer',
        required: true,
        validators: { isInt: { errorMsg: 'Integer' } },
      },
...
export function RegisterRoutes(app: express.Express) {
  ...
  // ###########################################################################################################
  app.post('/auth/signin', function (request: any, response: any, next: any) {
    const args = {
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  app.get('/user/self', authenticateMiddleware([{ apiKey: [] }]), function (
    request: any,
    response: any,
    next: any,
  ) {
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  app.post('/user', function (request: any, response: any, next: any) {
    const args = {
